      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <LandingFeatureLink
            ...
            className="hidden min-h-11 items-center rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-semibold text-white/80 transition hover:bg-white/10 hover:text-white lg:inline-flex"
            disabledClassName="hidden min-h-11 cursor-not-allowed items-center rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs font-semibold text-white/35 lg:inline-flex"
          >
            Analyze repos
          </LandingFeatureLink>
          <LandingFeatureLink
          ...
          <button
            ...
            className="flex min-h-11 min-w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 px-3 text-xs font-semibold text-white/80 transition hover:bg-white/20 lg:hidden"
          >
        ...
        {isMobileMenuOpen ? (
          <div
            ...
            className="absolute right-0 top-[calc(100%+0.75rem)] z-40 w-[min(22rem,calc(100vw-2rem))] max-w-[calc(100vw-2rem)] lg:hidden"
          >
