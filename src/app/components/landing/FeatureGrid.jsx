...
import GrowthCard from "@/app/UI/home/FeatureGridReusables/cards/growthCard";
...
export default function FeatureGrid() {
  ...
  return (
    <section id="solutions" className="feature-grid-section bg-[#0D0D0D] flex justify-between">
      <div className="fg-wrapper" style={{ "--quantity": components.length }}>
        <div className="fg-slider" ref={sliderRef}>
          {components.map((Comp, i) => (
            <div key={i} className="fg-item" style={{ "--position": i + 1 }}>
      ...
      <div className="h-full w-[60%] flex flex-col justify-center items-center text-center h-full">
        <GrowthCard />
      </div>
    </section>
  );
