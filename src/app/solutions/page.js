      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-24 pt-12 sm:px-6 sm:pt-16">
        <section className="rounded-[32px] border border-white/10 bg-[#101418]/95 p-6 shadow-[0_30px_100px_rgba(0,0,0,0.42)] sm:p-8 lg:p-10">
          ...
          <h1 className="mt-5 max-w-3xl text-4xl font-semibold leading-tight sm:text-5xl">
            Choose the path that matches where your GitHub presence needs work first.
          </h1>
          <p className="mt-5 max-w-2xl text-sm leading-7 text-white/65 sm:text-base">
            Each solution is designed to stand alone, but they connect into the same workflow so profile, README, and
            repository analysis stay in sync.
          </p>
        </section>
        ...
        <section className="mt-10 grid gap-6 rounded-[32px] border border-white/10 bg-[#111418] p-6 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#0b0d0f]">
            <Image src={assets.Highlights} alt="Solutions preview" className="h-auto w-full" />
          </div>
        </section>
      </main>
