...
export const metadata = buildMetadata({
  ...
  description:
    "Build a GitHub profile README with reusable blocks, live preview, tech stack sections, contribution widgets, and publishing workflows designed for developers.",
...
const profileBuilderSchema = createSoftwareApplicationSchema({
  ...
  featureList: [
    ...
    "Live markdown preview and publishing workflow",
  ],
});
